...
{
    lv_scr_load(guider_ui.ui_main);
}

void ui_app_load_comm_uart_screen(void)
{
    lv_scr_load(guider_ui.ui_comm_uart);
}

void ui_app_load_comm_can_screen(void)
{
    lv_scr_load(guider_ui.ui_comm_can);
}

void ui_app_load_led_screen(void)
{
    lv_scr_load(guider_ui.ui_led);
}

void ui_app_load_storage_screen(void)
{
    lv_scr_load(guider_ui.ui_storage);
}
